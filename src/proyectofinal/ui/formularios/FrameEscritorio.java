...
public class FrameEscritorio extends javax.swing.JFrame {
    ...
    public FrameEscritorio() {
        initComponents();
        this.archivoEscenario = new CrearArchivos<>();
        this.archivoVehiculos = new CrearArchivos<>();
        this.archivoArmas = new CrearArchivos<>();
        this.archivoJugador = new CrearArchivos<>();
    ...
    private void initComponents() {
        ...
        lblFondoEscritorio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectofinal/ui/imagenes/magical-nebula-4k-motion-background.jpg"))); // NOI18N
        ...
        panelDeEscritorioLayout.setHorizontalGroup(
            ...
            .addComponent(lblFondoEscritorio, javax.swing.GroupLayout.PREFERRED_SIZE, 831, Short.MAX_VALUE)
        );
        panelDeEscritorioLayout.setVerticalGroup(
            panelDeEscritorioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblFondoEscritorio, javax.swing.GroupLayout.PREFERRED_SIZE, 571, Short.MAX_VALUE)
        );
    ...
    private void crearEsenciarios() {
        CrearEscenario crearEscenario = new CrearEscenario(archivoEscenario);
