...
import proyectofinal.objetos.Batalla;
import proyectofinal.objetos.Escenario;
import proyectofinal.objetos.GenerarMovimiento;
...
public class FrameBatalla extends javax.swing.JInternalFrame {
     ...
     */
    public FrameBatalla(Escenario escenario, Jugador jugador, java.awt.Frame parent) {
        initComponents();
        this.parent =parent;
    ...
    private void botonAccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAccionActionPerformed
        ...
        if (comboAccion.getSelectedItem().toString().equalsIgnoreCase("Moverse")) {
            buscarPosicionJugador();
           Runnable runTower = new GenerarMovimiento(vehiculo, posicionX, posicionY, 1, casoDireccion(direccion), escenario.getTerrenos(), matrizLbl, valorDado);
